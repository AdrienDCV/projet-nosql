...
export const CreateBusinessPage = (): React.JSX.Element => {
  const { user } = useAuthentication();
  const { createNewBusiness } = useApp();

  const formik = useFormik<CreateBusinessForm>({
    initialValues: {
      name: "",
      street: "",
      number: "",
    ...
    onSubmit: async(values) => {
      ...
      createNewBusiness(createBusinessRequest);
  ...
  return (
      <div className="w-full h-full flex flex-col items-center justify-center">
        <div className="w-[500px] p-11 bg-white rounded-lg shadow-md">
          <h2 className="text-[24px] font-bold mb-4 text-center">Créez votre commerce !</h2>
          <form
